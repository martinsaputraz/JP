...
class RegisterApps extends StatefulWidget {
  const RegisterApps({super.key});

  @override
  State<RegisterApps> createState() => _RegisterAppsState();
}

class _RegisterAppsState extends State<RegisterApps> {
  /// FOR 'USERNAME'
