...
class HistoryBalance extends StatefulWidget {
  const HistoryBalance({Key? key}) : super(key: key);

  @override
  State<HistoryBalance> createState() => _HistoryBalanceState();
}

class _HistoryBalanceState extends State<HistoryBalance> {
  @override
  void initState() {
    super.initState();
  }
  ...
  List<WalletHistory> _getHistoryBalance() {
    // Replace this with the logic to fetch real data from your data source
    List<WalletHistory> getHistoryBalance = [
      WalletHistory(
        idData: 1,
      ...
      WalletHistory(
        ...
        minTransaction: "Rp 700.000",
        image: 'assets/images/food.jpg',
      ),
      WalletHistory(
        idData: 4,
        waktu: "10 Januari 2024",
        minTransaction: "Rp 600.000",
        image: 'assets/images/food.jpg',
      ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _historyWalletList(_getHistoryBalance()),
        ],
      ),
    );
  }
  ...
  Widget _historyWalletList(List<WalletHistory> historyWallet) {
    return Column(
      children: historyWallet.map((history) {
        return Padding(
          ...
          child: GestureDetector(
            onTap: () async {
              ...
              //   context,
              //   MaterialPageRoute(
              //       builder: (context) => const DetailHistoryBalance(
              //         idDetail: '',
              //       )),
              // );
            },
